...
const MenuWithFlatList = () => {


    const renderItem = ({item}) => <Item name={item.name}></Item>

    return (
        <View style={menuStyles.container}>
            <Text style={menuStyles.headerText}>Menu Items(Efficiemt)</Text>
            <FlatList 
            data={menuItems}
...
export default MenuWithFlatList
